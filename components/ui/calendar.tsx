...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex flex-col sm:flex-row space-y-8 sm:space-x-12 sm:space-y-0 !gap-12",
        ...
        nav_button: cn(
          ...
          "h-9 w-9 bg-transparent p-0 opacity-70 hover:opacity-100 transition-opacity"
        ),
        ...
        head_cell:
          "text-muted-foreground rounded-md w-12 font-bold text-xs uppercase tracking-wider",
        ...
        day: cn(
          ...
          "h-12 w-12 p-0 text-base font-medium aria-selected:opacity-100 hover:bg-accent rounded-lg transition-all duration-200"
        ),
